...
# --------------------------------------
# TEST: https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/test/docker-compose.yaml
# PROD: https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/main/docker-compose.yaml
fetch_if_missing_or_fallback \
    "https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/main/docker-compose.yaml" \
    "docker-compose.yaml" \
    "docker-compose.yaml"

# TEST: https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/test/deploy-plan.json
# PROD: https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/main/deploy-plan.json
fetch_if_missing_or_fallback \
    "https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/main/deploy-plan.json" \
    "deploy-plan.json" \
    "deploy-plan.json"

# GitHub Actions workflows — v3 bundle; remove legacy callers, then fetch if missing.
# TEST: https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/test/
# PROD: https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/main/
...
WORKFLOW_BASE="https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/main"
...
# TEST: https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/test/laravel-hooks/pre-commit
# PROD: https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/main/laravel-hooks/pre-commit
fetch_if_missing_or_fallback \
    "https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/main/laravel-hooks/pre-commit" \
...
if echo "$FORWARD_ARGS" | grep -qw -- --pv; then
    ...
    # TEST: https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/test/add-pv.sh
    # PROD: https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/main/add-pv.sh
    if curl -sSL -f -o "$ADD_PV_TMP" \
        "https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/main/add-pv.sh"; then
...
# TEST: https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/test/laravel-app.sh
# PROD: https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/main/laravel-app.sh
if curl -sSL -f -o "$LARAVEL_APP_TMP" \
    "https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/main/laravel-app.sh"; then
