...
fetch_if_missing_or_fallback \
    "https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/test/docker-compose.yaml" \
    "docker-compose.yaml" \
    "docker-compose.yaml"
...
fetch_if_missing_or_fallback \
    "https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/test/deploy-plan.json" \
    "deploy-plan.json" \
    "deploy-plan.json"
...
WORKFLOW_BASE="https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/test"
...
fetch_if_missing_or_fallback \
    "https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/test/laravel-hooks/pre-commit" \
...
if echo "$FORWARD_ARGS" | grep -qw -- --pv; then
    ...
    if curl -sSL -f -o "$ADD_PV_TMP" \
        "https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/test/add-pv.sh"; then
...
if curl -sSL -f -o "$LARAVEL_APP_TMP" \
    "https://raw.githubusercontent.com/Middle-Earth-Media/public-deploy-scripts/test/laravel-app.sh"; then
